...
<div class="min-h-screen bg-gray-50 font-sans">
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div id="sppd-table-container" class="bg-white shadow-md rounded-2xl overflow-hidden">
            <?php echo $__env->make('travel_requests.partials.sppd_table', ['travelRequests' => $travelRequests], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </main>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    filterForm.addEventListener('change', () => {
        ...
        const url = `<?php echo e(route('travel-requests.indexAll')); ?>?${params.toString()}`;
        fetchSppd(url);
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/travel_requests/daftar-sppd.blade.php ENDPATH**/ ?>