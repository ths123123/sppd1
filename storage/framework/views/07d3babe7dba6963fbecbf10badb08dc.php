...
<div class="min-h-screen bg-white pt-20 sm:pt-24">
    ...
    <div class="max-w-7xl w-full mx-auto px-3 sm:px-6 mt-4">
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['active']); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['pimpinan']); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['inactive']); ?></p>
                    ...
                    <tbody class="divide-y divide-gray-100" id="user-table-body">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="relative">
                                        <div class="h-10 w-10 rounded-xl bg-gradient-to-br <?php echo e($user->is_active ? 'from-blue-400 to-blue-600' : 'from-gray-400 to-gray-600'); ?> flex items-center justify-center text-white font-semibold shadow-sm">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900 font-medium"><?php echo e($user->nip ?? '-'); ?></div>
                                <div class="text-xs text-gray-500 mt-0.5"><?php echo e($user->jabatan ?? '-'); ?></div>
                            </td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <?php
                                    $roleStyles = [
                                ...
                                ?>
                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium <?php echo e($style); ?> border">
                                    <?php echo e($user->role === 'ppk' ? 'Pejabat Pembuat Komitmen' : $user->role); ?>

                                </span>
                            </td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($user->unit_kerja ?? '-'); ?></div>
                            </td>
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <?php if($user->is_active): ?>
                                    <div class="flex items-center">
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <?php if($user->last_login_at): ?>
                                    <div class="text-sm text-gray-900">
                                        <?php echo e(\Carbon\Carbon::parse($user->last_login_at)->format('d M Y')); ?>

                                    </div>
                                    <div class="text-xs text-gray-500">
                                        <?php echo e(\Carbon\Carbon::parse($user->last_login_at)->format('H:i')); ?>
                            ...
                            <td class="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <?php if($user->is_active): ?>
                                    <button onclick="toggleUserStatus(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', false)"
                                    ...
                                    <?php else: ?>
                                    <button onclick="toggleUserStatus(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', true)"
        ...
        <div class="w-full text-center mt-6 sm:mt-8 mb-4" id="last-updated-container">
            <p class="text-sm text-gray-500" id="last-updated">Last updated: <?php echo e(now()->format('d M Y, H:i')); ?></p>
        </div>
    </div>
</div>
...
async function toggleUserStatus(userId, userName, activateUser) {
    ...
    try {
        const response = await fetch(`<?php echo e(url('/users')); ?>/${userId}/toggle-status`, {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/users/list.blade.php ENDPATH**/ ?>