            ...
            <div class="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 w-full max-w-full px-2 sm:px-6 lg:px-8">
                ...
                <div class="relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 px-4 sm:px-8 py-6 sm:py-12 w-full max-w-full">
                    ...
                    <div class="relative z-10 flex flex-col items-center text-white">                        <!-- Profile Photo with Creative Frame -->
                                ...
                                <div class="w-full h-full bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 rounded-full p-1">
                                    ...
                                    <div class="w-full h-full bg-white rounded-full p-1">
                                        <div class="w-full h-full rounded-full overflow-hidden">
                                            <img src="<?php echo e($user->avatar_url); ?>" alt="<?php echo e($user->name); ?>" class="w-full h-full object-cover object-center">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Name and Title -->
                        <h1 class="text-lg font-bold mb-2"><?php echo e($user->name ?? '-'); ?></h1>
                        <?php if($user->role === 'ppk'): ?>
                            <p class="text-xs opacity-60 mt-1">Role: Pejabat Pembuat Komitmen</p>
                        <?php else: ?>
                            <p class="text-xs opacity-60 mt-1">Role: <?php echo e($user->getRoleDisplayName()); ?></p>
                        <?php endif; ?>
                ...
                <div class="px-4 sm:px-8 py-6 sm:py-8 w-full max-w-full">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e(\Carbon\Carbon::parse($user->birth_date)->format('d F Y')); ?></p>
                                        <p class="text-xs text-gray-400"><?php echo e(\Carbon\Carbon::parse($user->birth_date)->age); ?> years old</p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-start space-x-4">
                                    <div class="w-10 h-10 bg-pink-100 rounded-lg flex items-center justify-center">
                                        <i class="fas fa-<?php echo e($user->gender == 'male' ? 'user' : 'user'); ?> text-pink-600"></i>
                                    </div>
                                    <div>
                                        <p class="text-sm text-gray-500">Gender</p>
                                        <p class="text-gray-900 font-medium"><?php echo e(ucfirst($user->gender)); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e($user->employee_id); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e($user->pangkat); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <div class="flex items-start space-x-4">
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e($user->golongan ?? '-'); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e($user->unit_kerja); ?></p>
                                    </div>
                                </div>
                                <?php endif; ?>
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-900 font-medium"><?php echo e($user->role === 'ppk' ? 'Pejabat Pembuat Komitmen' : $user->getRoleDisplayName()); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6">
                            <p class="text-gray-700 leading-relaxed italic"><?php echo e($user->bio); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mt-8 pt-8 border-t border-gray-200">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <div class="flex items-center space-x-4">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($user->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <span class="w-2 h-2 mr-2 rounded-full <?php echo e($user->is_active ? 'bg-green-500' : 'bg-red-500'); ?>"></span>
                                        <?php echo e($user->is_active ? 'Active' : 'Inactive'); ?>

                                    </span>
                                    <?php if($user->last_login_at): ?>
                                        <span class="text-sm text-gray-500">
                                            Last login: <?php echo e($user->last_login_at->diffForHumans()); ?>
                            ...
                            <div class="text-right">
                                ...
                                <p class="text-lg font-semibold text-gray-900"><?php echo e($user->created_at->format('M Y')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/profile/show.blade.php ENDPATH**/ ?>