<?php $__env->startSection('title', 'Edit SPPD'); ?>
...
<div class="sppd-container">
    <div class="sppd-card max-w-5xl mx-auto">
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-red-800">
                        Pesan Revisi dari <?php echo e($latestRevision->approver->name ?? 'Approver'); ?>

                    </h3>
                    <div class="mt-2 text-sm text-red-700">
                        <p class="font-medium">Alasan Revisi:</p>
                        <p class="mt-1"><?php echo e($latestRevision->comments ?? 'Tidak ada pesan revisi'); ?></p>
                    </div>
                    <div class="mt-2 text-xs text-red-600">
                        <i class="fas fa-clock mr-1"></i>
                        <?php echo e($latestRevision->created_at->format('d/m/Y H:i')); ?>
        ...
        <div class="sppd-form-content">
            ...
            <?php endif; ?>
            <form id="sppd-form" method="POST" action="<?php echo e(route('travel-requests.update', $travelRequest->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="section-card">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="<?php echo e($user->nip); ?>" readonly>
                        </div>
                    </div>
                    <div class="form-group" style="margin-top:18px;">
                        ...
                        <input type="hidden" name="participants[]" id="participants-hidden" value="<?php echo e($travelRequest->participants ? $travelRequest->participants->pluck('id')->implode(',') : ''); ?>">
                        <!-- Tambahan hidden inputs untuk setiap peserta -->
                        <?php if($travelRequest->participants): ?>
                            <?php $__currentLoopData = $travelRequest->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div id="peserta-terpilih-table" class="mt-3">
                            <?php if($travelRequest->participants && $travelRequest->participants->count() > 0): ?>
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <h4 class="text-sm font-medium text-blue-800 mb-2">
                                        <i class="fas fa-users mr-1"></i> Peserta yang Sudah Dipilih (<?php echo e($travelRequest->participants->count()); ?>)
                                    </h4>
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $travelRequest->participants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center justify-between bg-white rounded-lg p-3 border border-blue-100">
                                                <div class="flex items-center">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($participant->name); ?></p>
                                                        <p class="text-xs text-gray-500"><?php echo e($participant->role); ?></p>
                                                    </div>
                                                </div>
                                                <button type="button" class="text-red-500 hover:text-red-700 remove-peserta-btn" data-participant-id="<?php echo e($participant->id); ?>" title="Hapus peserta">
                ...
                <div class="section-card">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_berangkat" class="form-input" required value="<?php echo e(old('tempat_berangkat', $travelRequest->tempat_berangkat)); ?>" placeholder="Masukkan tempat berangkat">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">Tujuan</label>
                            <input type="text" name="tujuan" class="form-input" required value="<?php echo e(old('tujuan', $travelRequest->tujuan)); ?>" placeholder="Masukkan tujuan perjalanan">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">Keperluan</label>
                            <input type="text" name="keperluan" class="form-input" required value="<?php echo e(old('keperluan', $travelRequest->keperluan)); ?>" placeholder="Masukkan keperluan perjalanan">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">Tanggal Berangkat</label>
                            <input type="date" name="tanggal_berangkat" class="form-input" required value="<?php echo e(old('tanggal_berangkat', $travelRequest->tanggal_berangkat->format('Y-m-d'))); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">Tanggal Kembali</label>
                            <input type="date" name="tanggal_kembali" class="form-input" required value="<?php echo e(old('tanggal_kembali', $travelRequest->tanggal_kembali->format('Y-m-d'))); ?>">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">Transportasi</label>
                            <select name="transportasi" class="form-select" required>
                                <option value="Pesawat" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Pesawat' ? 'selected' : ''); ?>>Pesawat</option>
                                <option value="Kereta Api" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Kereta Api' ? 'selected' : ''); ?>>Kereta Api</option>
                                <option value="Bus" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Bus' ? 'selected' : ''); ?>>Bus</option>
                                <option value="Kendaraan Dinas" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Kendaraan Dinas' ? 'selected' : ''); ?>>Kendaraan Dinas</option>
                                <option value="Kendaraan Pribadi" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Kendaraan Pribadi' ? 'selected' : ''); ?>>Kendaraan Pribadi</option>
                                <option value="Lainnya" <?php echo e(old('transportasi', $travelRequest->transportasi) == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Tempat Menginap</label>
                            <input type="text" name="tempat_menginap" class="form-input" value="<?php echo e(old('tempat_menginap', $travelRequest->tempat_menginap)); ?>" placeholder="Nama hotel/penginapan (opsional)">
                        </div>
                    </div>
                </div>
                ...
                <div class="section-card">
                    ...
                    <div class="form-group" style="padding: 24px;">
                        ...
                        <?php if($travelRequest->documents && $travelRequest->documents->count() > 0): ?>
                            <div class="mt-4">
                                <h4 class="text-sm font-semibold mb-2">Dokumen yang sudah diupload:</h4>
                                <ul class="list-disc pl-5">
                                    <?php $__currentLoopData = $travelRequest->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="text-sm text-gray-700"><?php echo e($document->original_filename); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        <?php endif; ?>
                ...
                <div class="section-card">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="biaya_transport" name="biaya_transport" class="form-input biaya-input" min="0" value="<?php echo e(old('biaya_transport', (int)$travelRequest->biaya_transport)); ?>" placeholder="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Biaya Penginapan</label>
                            <input type="text" id="biaya_penginapan" name="biaya_penginapan" class="form-input biaya-input" min="0" value="<?php echo e(old('biaya_penginapan', (int)$travelRequest->biaya_penginapan)); ?>" placeholder="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Uang Harian</label>
                            <input type="text" id="uang_harian" name="uang_harian" class="form-input biaya-input" min="0" value="<?php echo e(old('uang_harian', (int)$travelRequest->uang_harian)); ?>" placeholder="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Biaya Lainnya <span class=\"text-xs text-gray-500 ml-2\">(misal: tol, parkir, konsumsi, ATK, dll.)</span></label>
                            <input type="text" id="biaya_lainnya" name="biaya_lainnya" class="form-input biaya-input" min="0" value="<?php echo e(old('biaya_lainnya', (int)$travelRequest->biaya_lainnya)); ?>" placeholder="0">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Sumber Dana</label>
                            <select name="sumber_dana" class="form-select">
                                <option value="">Pilih Sumber Dana</option>
                                <option value="APBD" <?php echo e(old('sumber_dana', $travelRequest->sumber_dana) == 'APBD' ? 'selected' : ''); ?>>APBD</option>
                                <option value="APBN" <?php echo e(old('sumber_dana', $travelRequest->sumber_dana) == 'APBN' ? 'selected' : ''); ?>>APBN</option>
                                <option value="Dana Lainnya" <?php echo e(old('sumber_dana', $travelRequest->sumber_dana) == 'Dana Lainnya' ? 'selected' : ''); ?>>Dana Lainnya</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-card">
                    ...
                    <div class="p-4">
                        ...
                        <?php if($revisionNote): ?>
                            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
                                <div class="flex items-start">
                                    ...
                                    ?>
                                    <?php if($revisionData && isset($revisionData['approver_avatar'])): ?>
                                        <div class="flex-shrink-0 mr-3">
                                            <img src="<?php echo e($revisionData['approver_avatar']); ?>" alt="<?php echo e($revisionData['approved_by'] ?? 'Approver'); ?>" class="w-8 h-8 rounded-full object-cover border border-yellow-400">
                                        </div>
                                    <?php else: ?>
                                        <div class="flex-shrink-0 mr-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm text-yellow-700">
                                            <strong>Catatan Revisi dari <?php echo e($revisionData['approved_by'] ?? 'Approver'); ?>:</strong>
                                        </p>
                                        <p class="text-sm text-yellow-700 mt-1"><?php echo e($revisionNote); ?></p>
                                        <?php if(isset($revisionData['timestamp'])): ?>
                                            <p class="text-xs text-yellow-600 mt-1"><?php echo e(\Carbon\Carbon::parse($revisionData['timestamp'])->format('d M Y, H:i')); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group mt-4">
                            ...
                            <textarea name="catatan_pemohon" class="form-input" rows="3" placeholder="Tambahkan catatan untuk perubahan yang dilakukan (opsional)"><?php echo e(old('catatan_pemohon', $travelRequest->catatan_pemohon)); ?></textarea>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="<?php echo e(route('travel-requests.submit', $travelRequest->id)); ?>" class="mt-4" id="submit-form">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('travel_requests.partials.peserta-modal', ['users' => $users, 'selected' => old('participants', $travelRequest->participants ? $travelRequest->participants->pluck('id')->toArray() : [])], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('scripts'); ?>
<script>
    window.users = <?php echo json_encode($users, 15, 512) ?>;
    window.selectedPeserta = <?php echo json_encode(old('participants', $travelRequest->participants ? $travelRequest->participants->pluck('id')->toArray() : []), 512) ?>;
    
    // Debug: Log data peserta untuk memastikan ter-load dengan benar
    console.log('Debug - Travel Request ID:', <?php echo json_encode($travelRequest->id, 15, 512) ?>);
    console.log('Debug - Travel Request Participants:', <?php echo json_encode($travelRequest->participants, 15, 512) ?>);
...
<script src="<?php echo e(asset('js/forms/sppd-form-professional.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/travel_requests/edit.blade.php ENDPATH**/ ?>