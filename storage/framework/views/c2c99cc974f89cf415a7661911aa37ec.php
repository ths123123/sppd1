                    ...
                    <div class="md:w-1/3 mt-8 md:mt-0 flex justify-center">
                        <div class="bg-white bg-opacity-20 p-4 rounded-lg backdrop-filter backdrop-blur-sm border border-white border-opacity-20 shadow-lg">
                            <div class="text-center">
                                ...
                                <div class="text-white text-lg font-bold"><?php echo e(now('Asia/Jakarta')->format('d M Y')); ?></div>
                                <div class="text-white text-opacity-80 text-sm"><?php echo e(now('Asia/Jakarta')->format('H:i:s')); ?> WIB</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="flex items-baseline">
                                <p class="text-2xl font-bold text-gray-900" id="approved-count"><?php echo e($approvedCount ?? 0); ?></p>
                ...
                <div class="px-6 py-5 sm:px-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-6">
                            ...
                            <div class="flex items-baseline">
                                <p class="text-2xl font-bold text-gray-900" id="rejected-count"><?php echo e($rejectedCount ?? 0); ?></p>
                ...
                <div class="px-6 py-5 sm:px-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="flex items-baseline">
                                <p class="text-2xl font-bold text-gray-900" id="review-count"><?php echo e($reviewCount ?? 0); ?></p>
                ...
                <div class="px-6 py-5 sm:px-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5">
                            ...
                            <div class="flex items-baseline">
                                <p class="text-2xl font-bold text-gray-900" id="document-count"><?php echo e($documentCount ?? 0); ?></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <a href="<?php echo e(route('my-travel-requests.index')); ?>" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors duration-200">
                    ...
                    <a href="<?php echo e(route('documents.index')); ?>" class="flex items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/dashboard/dashboard-utama.blade.php ENDPATH**/ ?>