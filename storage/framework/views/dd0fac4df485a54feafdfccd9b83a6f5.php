<?php $__env->startSection('title', 'Buat SPPD Baru'); ?>
...
<div class="sppd-container">
    ...
    <?php endif; ?>
            <form id="sppd-form" method="POST" action="<?php echo e(route('travel-requests.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="<?php echo e($user->name); ?>" readonly aria-label="Nama Lengkap">
                        </div>
                        <div class="form-group">
                            <label class="form-label required">NIP</label>
                            <input type="text" class="form-input" value="<?php echo e($user->nip); ?>" readonly aria-label="NIP">
                        </div>
                    </div>
            ...
            <div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_berangkat" class="form-input" required value="<?php echo e(old('tempat_berangkat', 'Cirebon (Sumber)')); ?>" placeholder="Masukkan tempat berangkat">
            </div>
                        <div class="form-group">
                            <label class="form-label required">Tujuan</label>
                            <input type="text" name="tujuan" class="form-input" required value="<?php echo e(old('tujuan')); ?>" placeholder="Masukkan tujuan perjalanan">
            </div>
                        <div class="form-group">
                            <label class="form-label required">Keperluan</label>
                            <input type="text" name="keperluan" class="form-input" required value="<?php echo e(old('keperluan')); ?>" placeholder="Masukkan keperluan perjalanan">
            </div>
                        <div class="form-group">
                            <label class="form-label required">Tanggal Berangkat</label>
                            <input type="date" name="tanggal_berangkat" class="form-input" required value="<?php echo e(old('tanggal_berangkat')); ?>" aria-label="Tanggal Berangkat">
            </div>
                        <div class="form-group">
                            <label class="form-label required">Tanggal Kembali</label>
                            <input type="date" name="tanggal_kembali" class="form-input" required value="<?php echo e(old('tanggal_kembali')); ?>" aria-label="Tanggal Kembali">
            </div>
                        <div class="form-group">
                    ...
                    <option value="">Pilih Transportasi</option>
                                <option value="Pesawat" <?php echo e(old('transportasi') == 'Pesawat' ? 'selected' : ''); ?>>Pesawat</option>
                                <option value="Kereta Api" <?php echo e(old('transportasi') == 'Kereta Api' ? 'selected' : ''); ?>>Kereta Api</option>
                                <option value="Bus" <?php echo e(old('transportasi') == 'Bus' ? 'selected' : ''); ?>>Bus</option>
                                <option value="Kendaraan Dinas" <?php echo e(old('transportasi') == 'Kendaraan Dinas' ? 'selected' : ''); ?>>Kendaraan Dinas</option>
                                <option value="Kendaraan Pribadi" <?php echo e(old('transportasi') == 'Kendaraan Pribadi' ? 'selected' : ''); ?>>Kendaraan Pribadi</option>
                                <option value="Lainnya" <?php echo e(old('transportasi') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Tempat Menginap</label>
                            <input type="text" name="tempat_menginap" class="form-input" value="<?php echo e(old('tempat_menginap')); ?>" placeholder="Nama hotel/penginapan (opsional)">
                        </div>
            </div>
        </div>
                <!-- Anggaran & Biaya -->
            ...
            <div>
                    ...
                    <option value="">Pilih Sumber Dana</option>
                                <option value="APBD" <?php echo e(old('sumber_dana') == 'APBD' ? 'selected' : ''); ?>>APBD</option>
                                <option value="APBN" <?php echo e(old('sumber_dana') == 'APBN' ? 'selected' : ''); ?>>APBN</option>
                                <option value="Dana Lainnya" <?php echo e(old('sumber_dana') == 'Dana Lainnya' ? 'selected' : ''); ?>>Dana Lainnya</option>
                </select>
            </div>
        </div>
        </div>
...
<div class="w-full text-center mt-8 mb-4">
    <p class="text-sm text-gray-500">Terakhir diperbarui: <?php echo e(now()->format('d/m/Y H:i')); ?></p>
</div>
<?php echo $__env->make('travel_requests.partials.peserta-modal', ['users' => $users, 'selected' => old('participants', [])], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startPush('scripts'); ?>
<script>
    window.users = <?php echo json_encode($users, 15, 512) ?>;
    window.selectedPeserta = <?php echo json_encode(old('participants', []), 512) ?>;
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="<?php echo e(asset('js/forms/sppd-form-professional.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/travel_requests/create.blade.php ENDPATH**/ ?>