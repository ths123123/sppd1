    ...
    <div x-show="open" x-transition.opacity class="mobile-offcanvas" @click.self="open = false; closeAll();" style="display: none;">
        <nav class="mobile-offcanvas-panel" x-transition:enter="transition transform duration-300" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition transform duration-200" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full">
            <div class="mobile-menu-header flex items-center gap-3 px-4 py-3 border-b border-gray-100">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-12 w-12 object-contain rounded-lg shadow-sm mr-2">
            ...
            <div class="mobile-menu-list">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="mobile-menu-item text-black <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
                ...
                <div x-show="sppdOpen" x-transition class="pl-10 space-y-1">
                    ...
                    <a href="<?php echo e(route('my-travel-requests.index')); ?>" class="mobile-menu-item text-black">
                        SPPD Saya
                    </a>
                ...
                <div x-show="dokumenOpen" x-transition class="pl-10 space-y-1">
                    <a href="<?php echo e(route('documents.index')); ?>" class="mobile-menu-item text-black">
                        Dokumen Saya
                    </a>
                ...
                <a href="<?php echo e(route('profile.show')); ?>" class="mobile-menu-item text-black">
                ...
                <a href="<?php echo e(route('settings.index')); ?>" class="mobile-menu-item text-black">
...
<?php /**PATH D:\pkl\SPPD-KP1\SPPD-KPUKP1\resources\views/components/navigation/mobile-menu.blade.php ENDPATH**/ ?>