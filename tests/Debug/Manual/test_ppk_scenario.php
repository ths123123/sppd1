...
echo "=== TESTING PPK REVISION SCENARIO ===\n\n";

$approvalService = new ApprovalService();

echo "=== SCENARIO: PPK REVISES TO KASUBBAG (BOTH SEKRETARIS AND PPK APPROVED) ===\n";
...
// Add both Sekretaris and PPK approvals
Approval::create([
...
if ($updatedRequest->status === 'completed') {
    echo "✅ SUCCESS: All approvals completed, SPPD marked as completed!\n";
} elseif ($updatedRequest->current_approval_level == $expectedLevel) {
