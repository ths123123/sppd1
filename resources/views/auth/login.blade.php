                ...
                <div class="card-shadow rounded-2xl p-4 bg-white border border-gray-100">
                    <form class="space-y-4" method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" class="w-full px-3 py-2 border border-gray-300 rounded-lg input-focus outline-none transition-all text-sm" placeholder="Masukkan email Anda" required autofocus value="{{ old('email') }}">
                        </div>
                        <div>
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center">
                                <input type="checkbox" name="remember" class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500" {{ old('remember') ? 'checked' : '' }}>
                                <span class="ml-2 text-xs text-gray-600">Ingat saya</span>
                            </label>
                            @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs text-purple-600 hover:text-purple-500">Lupa kata sandi?</a>
                            @endif
                        </div>
            ...
            <div class="card-shadow rounded-2xl p-6 bg-white">
                ...
                <form class="space-y-4" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg input-focus outline-none" placeholder="Masukkan email Anda" required autofocus value="{{ old('email') }}">
                    </div>
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="w-4 h-4 text-purple-600 border-gray-300 rounded" {{ old('remember') ? 'checked' : '' }}>
                            <span class="ml-2 text-gray-600">Ingat saya</span>
                        </label>
                        @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-purple-600">Lupa kata sandi?</a>
                        @endif
                    </div>
