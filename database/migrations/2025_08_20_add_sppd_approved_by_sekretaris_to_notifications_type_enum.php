...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE notifications ADD CONSTRAINT notifications_type_check 
            CHECK (type::text = ANY (ARRAY[
                ...
                'sppd_rejected'::text, 'sppd_revision'::text, 'sppd_approved'::text, 'sppd_approved_by_sekretaris'::text
            ]));");
    }
    ...
    {
        // Revert to the previous constraint without 'sppd_approved_by_sekretaris'
        DB::statement('ALTER TABLE notifications DROP CONSTRAINT IF EXISTS notifications_type_check');
